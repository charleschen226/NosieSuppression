...
/* ./.libs/lt-timewarp-file.c - temporary wrapper executable for .libs/timewarp-file.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-3

   The timewarp-file program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "timewarp-file.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# timewarp-file - temporary wrapper script for .libs/timewarp-file.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-3\n", f);
  fputs ("#\n", f);
  fputs ("# The timewarp-file program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"timewarp-file.exe:timewarp-file:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-3\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"timewarp-file.exe:timewarp-file:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"timewarp-file.exe:timewarp-file:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='timewarp-file.exe'\n", f);

...
/* ./.libs/lt-multichan_throughput_test.c - temporary wrapper executable for .libs/multichan_throughput_test.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-3

   The multichan_throughput_test program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "E:\\MinGW\\msys\\1.0\\libsamplerate-0.1.8\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "E:\\MinGW\\msys\\1.0\\libsamplerate-0.1.8\\src\\.libs;E:\\MinGW\\msys\\1.0\\home\\lenovo\\lib;E:\\MinGW\\msys\\1.0\\home\\lenovo\\bin;";
const char * TARGET_PROGRAM_NAME = "multichan_throughput_test.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4 Debian-2.4-3\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# multichan_throughput_test - temporary wrapper script for .libs/multichan_throughput_test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-3\n", f);
  fputs ("#\n", f);
  fputs ("# The multichan_throughput_test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libsamplerate.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"multichan_throughput_test.exe:multichan_throughput_test:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-3\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"multichan_throughput_test.exe:multichan_throughput_test:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"multichan_throughput_test.exe:multichan_throughput_test:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='multichan_throughput_test.exe'\n", f);
  ...
  fputs ("    PATH=/libsamplerate-0.1.8/src/.libs:/home/lenovo/lib:/home/lenovo/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/libsamplerate-0.1.8/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);

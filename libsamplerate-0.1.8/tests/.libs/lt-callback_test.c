...
/* ./.libs/lt-callback_test.c - temporary wrapper executable for .libs/callback_test.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-3

   The callback_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "callback_test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# callback_test - temporary wrapper script for .libs/callback_test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-3\n", f);
  fputs ("#\n", f);
  fputs ("# The callback_test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"callback_test.exe:callback_test:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-3\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"callback_test.exe:callback_test:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"callback_test.exe:callback_test:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='callback_test.exe'\n", f);

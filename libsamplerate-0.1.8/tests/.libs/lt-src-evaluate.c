...
/* ./.libs/lt-src-evaluate.c - temporary wrapper executable for .libs/src-evaluate.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-3

   The src-evaluate program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "src-evaluate.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# src-evaluate - temporary wrapper script for .libs/src-evaluate.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-3\n", f);
  fputs ("#\n", f);
  fputs ("# The src-evaluate program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"src-evaluate.exe:src-evaluate:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-3\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"src-evaluate.exe:src-evaluate:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"src-evaluate.exe:src-evaluate:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='src-evaluate.exe'\n", f);
